...
def menus(context, _get_config=None):
    ...
    for app in app_list:
        _models = [
            {
                'name':
                    m.get('name'),
                'icon':
                    get_icon(m.get('object_name'), unicode_to_str(m.get('name'))),
                'url':
                    m.get('admin_url'),
                'addUrl':
                    m.get('add_url'),
        ...
        module = {'name': app.get('name'), 'icon': get_icon(app.get('app_label'), app.get('name')), 'models': _models}
        data.append(module)
...
def get_icon(obj, name=None):
    ...
    _dict = {'auth': 'fas fa-shield-alt', 'User': 'far fa-user', 'Group': 'fas fa-users-cog'}
